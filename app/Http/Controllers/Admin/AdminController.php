...
class AdminController extends Controller
{
    public function index(Request $request)
    {
        ...
        $jumlahKK = (auth()->user()->penduduk->jabatan == 'Ketua RW') ? KartuKeluargaModel::where('niKeluarga', '!=', '0000000000000001')->count() : KartuKeluargaModel::where('niKeluarga', '!=', '0000000000000001')->where('rt', auth()->user()->penduduk->kartuKeluarga->rt)->count();
        $jumlahPenduduk = (auth()->user()->penduduk->jabatan == 'Ketua RW') ? PendudukModel::where('nik', '!=', '0000000000000001')->count() : PendudukModel::join('tb_kartukeluarga', 'tb_penduduk.id_kartuKeluarga', '=', 'tb_kartukeluarga.id_kartuKeluarga')->where('nik', '!=', '0000000000000001')->where('tb_kartukeluarga.rt', auth()->user()->penduduk->kartuKeluarga->rt)->count();
        $jumlahUmkm = (auth()->user()->penduduk->jabatan == 'Ketua RW') ? UmkmModel::count() : UmkmModel::join('tb_penduduk', 'tb_penduduk.id_penduduk', '=', 'tb_umkm.id_pemilik')->join('tb_kartukeluarga', 'tb_penduduk.id_kartuKeluarga', '=', 'tb_kartukeluarga.id_kartuKeluarga')->where('tb_kartukeluarga.rt', auth()->user()->penduduk->kartuKeluarga->rt)->count();
        $jumlahAduan = (auth()->user()->penduduk->jabatan == 'Ketua RW') ? AduanModel::count() : AduanModel::join('tb_penduduk', 'tb_penduduk.id_penduduk', '=', 'tb_aduan.pengadu_id')->join('tb_kartukeluarga', 'tb_penduduk.id_kartuKeluarga', '=', 'tb_kartukeluarga.id_kartuKeluarga')->where('tb_kartukeluarga.rt', auth()->user()->penduduk->kartuKeluarga->rt)->count();
        ...
        $dataPendudukAll = (auth()->user()->penduduk->jabatan == 'Ketua RW') ? PendudukModel::where('nik', '!=', '0000000000000001')->get() : PendudukModel::join('tb_kartukeluarga', 'tb_penduduk.id_kartuKeluarga', '=', 'tb_kartukeluarga.id_kartuKeluarga')->where('tb_kartukeluarga.rt', auth()->user()->penduduk->kartuKeluarga->rt)->where('nik', '!=', '0000000000000001')->get();
        ...
        $dataBansos = (auth()->user()->penduduk->jabatan == 'Ketua RW') ? AjuanBansosModel::where('status', 'diterima')->whereYear('created_at', $yearBansos) : AjuanBansosModel::where('tb_ajuan_bansos.status', 'diterima')->whereYear('tb_ajuan_bansos.created_at', $yearBansos)->join('tb_kartukeluarga', 'tb_ajuan_bansos.id_kartuKeluarga', '=', 'tb_kartukeluarga.id_kartuKeluarga')->where('tb_kartukeluarga.rt', auth()->user()->penduduk->kartuKeluarga->rt);
