...
<div class="lg:min-h-[100vh] mx-auto lg:py-[34px] w-[100%] lg:w-[90%]">
    <div class="flex flex-row gap-14 lg:mt-9 w-full">
        ...
        <div class="lg:basis-3/4 lg:block hidden ">
            ...
            {{-- <div class="hidden pt-14   justify-center lg:hidden flex-col gap-y-10 h-fit w-[90%]  mx-auto dark:bg-[#24292d]">
        ...
        <div class="pt-48 justify-center sm:hidden flex-col gap-y-10 h-fit flex w-[90%] mx-auto dark:bg-[#24292d]">
            @foreach ($umkms as $umkm)
                <a href="{{ route('umkm.detail', ['umkm_id' => $umkm->umkm_id]) }}">
                    <div class="shadow-xl rounded-2xl overflow-hidden border-black border-2 dark:text-white dark:bg-[#30373F] justify-start">
                        <div class="flex justify-start items-end relative">
                            <img src="{{ asset('assets/images/' . $umkm->foto) }}" alt="" class="h-50 w-full group-hover:scale-110 object-cover transition ease-in-out duration-500">
                            @if($umkm->buka_waktu && $umkm->tutup_waktu)
                                <div class="py-3 px-4 absolute z-1 bg-[#2d5523] dark:bg-[#57ba47] text-xl -bottom-7 left-5 rounded-full text-white font-semibold flex items-center gap-2">
                                    <i class="fa-regular fa-clock"></i>
