                    ...
                    <div class="felx justify-end pb-7">
                        <div class="" x-data="{ 'editModal': false }" @keydown.escape="editModal = false">
                            ...
                            <div x-show="editModal" x-cloak tabindex="-1" aria-hidden="true"
                                ...
                                <div class="absolute z-999 bg-black/25 h-[100vh] w-full"></div>
                                <div class="relative z-[1000] p-4 w-full max-h-[700px]"
        ...
        <table class="sm:w-full w-150 text-sm text-left rtl:text-right table-fixed text-gray-500 dark:text-gray-400">
            <thead class="text-base text-white uppercase bg-[#436c39] text-center dark:bg-[#428238] dark:text-white">
                <tr>
                    ...
                    <th scope="col" class="px-6  w-[11%] py-3 hidden lg:table-cell">
                        Jam Tutup
                    </th>
                    ...
                    <th scope="col" class="px-6  lg:w-[9%] sm:w-[20%] w-35 py-3 ">
                        Status
                    </th>
                </tr>
            </thead>
            <tbody>
                @foreach ($umkms as $umkm)
                    <tr
                        ...
                        <td scope="row"
                            class="px-6  py-4 font-medium text-base text-center text-[#2d5523]  dark:text-white  lg:hidden">
                            {{ $umkm->buka_waktu }} - {{ $umkm->tutup_waktu }}
                        </td>
                        <td scope="row"
                            class="px-6  py-4 font-medium text-base text-center text-[#2d5523]  dark:text-white hidden lg:table-cell">
                            {{ $umkm->buka_waktu }}
                        </td>
                        <td scope="row"
                            class="px-6   py-4 font-medium text-base text-center text-[#2d5523]  dark:text-white hidden lg:table-cell">
                        ...
                        <td class="hidden lg:table-cell">
                            <div class="flex justify-center ">
                                <button
                                    ...
                                    data-modal-target="lihat-foto1" data-modal-toggle="lihat-foto1">
                                        ...
                                        <div class="relative p-10 w-full  max-h-full">
                                            ...
                                            <div class="relative bg-white w-115  dark:bg-gray-700">
                                                <img src="{{ asset('assets/images/' . $umkm->foto) }}"
                                                    {{-- <img src="{{ asset('assets/images/UMKM/oLtUGlIJjAJwSCQVqGDgiZl277Snsa7AdYUkCrFf.jpg') }}" --}} alt="" class="w-full">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="px-6 py-4 w-full flex gap-4 justify-center h-full items-center">
                                ...
                                <div x-data="{ 'detailModal': false }" @keydown.escape="detailModal = false">
                                    ...
                                    <div x-show="detailModal"
                                        ...
                                        x-transition:leave-end="md:transition-none translate-y-full" tabindex="-1"
                                        aria-hidden="true"
                                        ...
                                        <div class="relative z-[1000] sm:p-4 w-full sm:w-fit sm:max-w-3xl h-fit"
                                                        ...
                                                        <div class="col-span-2 sm:col-span-1 grid grid-cols-2 gap-4">
                                                            <div class="col-span-2 sm:col-span-1">
                                                                <label for="jam-buka"
                                                                    ...
                                                                    Buka</label>
                                                                <input type="time" name="jam-buka" id="jam-buka"
                                                                    class="bg-white shadow-md border border-[#34662C] text-sm dark:border-gray-500 dark:bg-[#505c6a] rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white"
                                                            ...
                                                            <div class="col-span-2 sm:col-span-1">
                                                                <label for="jam-tutup"
                                                                    class="block mb-2 text-sm font-bold">Jam
                                                                    Tutup</label>
                                                                <input type="time" name="jam-tutup" id="jam-tutup"
                                                                    class="bg-white shadow-md border border-[#34662C] text-sm dark:border-gray-500 dark:bg-[#505c6a] rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white"
                                                        ...
                                                        <div class="col-span-2">
                                                            ...
                                                            <div class="basis-3/4 h-full flex items-center">
                                                                <input id="kelas" list="listKelas" name="kelas"
                                                                    disabled value="{{ $kategori }}" readonly
                                                        ...
                                                        <div class="col-span-2">
                                                            <div
                                                                ...
                                                                <div x-data="{ 'fotoModal': false }"
                                                                    ...
                                                                    <button type="button" @click="fotoModal = true"
                                                ...
                                                <form action="{{ route('umkm.edit', ['umkm_id' => $umkm->umkm_id]) }}"
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="col-span-2">
                                                            <label for="koordinat"
                                                                class="block mb-2 text-sm font-bold">Koordinat</label>
                                                            <input type="text" name="lokasi_map" id="koordinat"
                                                                class="bg-white shadow-md border border-[#34662C] text-sm dark:border-gray-500 dark:bg-[#505c6a] rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white"
                                ...
                                @if ($umkm->status === 'diproses')
                                    <form id="cancel-umkm-form-{{ $umkm->umkm_id }}"
                                        action="{{ route('umkm.cancel', $umkm->umkm_id) }}" method="POST"
                                        style="display: none;">
                                        @csrf
                                    </form>
                                    <button type="button"
                                ...
                                @else
                                    <form id="delete-umkm-form-{{ $umkm->umkm_id }}"
                                        action="{{ route('umkm.destroy', $umkm->umkm_id) }}" method="POST"
                                        style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                    </form>
