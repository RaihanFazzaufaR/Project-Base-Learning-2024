...
<div class="w-[100%] hidden lg:flex relative justify-center items-center ">
...
<div class=" lg:hidden sm:sticky sm:top-0 fixed text-[#2d5523] w-[100%] dark:text-white font-bold border-b-2 z-9  bg-white dark:bg-[#2F363E] h-fit border-gray-300 dark:border-gray-600 py-6">
    <div class="w-[90%] mx-auto gap-4 flex flex-col">
        <div class=" text-2xl sm:text-4xl flex flex-col gap-2">
            ...
            <p class="text-[#2d5523] dark:text-white font-sans sm:text-lg text-sm  text-left">Bangun Ekonomi Berkelanjutan
