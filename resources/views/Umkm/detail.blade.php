...
<div class="hidden lg:flex min-h-[100vh] lg:mx-auto  md:py-[34px] w-[90%] ">
    <div class="w-full flex h-fit gap-10 flex-row mt-7 ">
        <div
            class="basis-1/3 w-full  dark:bg-[#505c6a] border-[3px] h-fit rounded-lg border-[#2d5523] dark:border-gray-500">
        ...
        <div class="basis-2/3  lg:flex w-full border-[3px] rounded-lg border-[#2d5523]">
...
<div class="pt-7">
    ...
    <div class="h-fit w-[90%] lg:hidden mx-auto   border-2 dark:border-600 rounded-2xl overflow-hidden bg-white dark:bg-[#30373F]">
        <div class="sm:flex gap-3">
            <div class="basis-1/3">
                <img src="{{ asset('assets/images/' . $umkm->foto) }}" alt=""
                    class="w-full lg:hidden mb-3 h-67 object-cover ">
            </div>
            <div class="basis-2/3">
                <div class="text-3xl px-3 py-3 font-semibold text-[#2d5523] dark:text-white">
                    {{ $umkm->nama }}
                </div>
        ...
        <div class="w-full px-[20px] flex flex-col gap-y-5 pb-5">
            <a href="https://wa.me/{{ $umkm->no_wa }}"
