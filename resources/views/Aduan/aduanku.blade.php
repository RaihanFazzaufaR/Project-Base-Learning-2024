                ...
                <div class="w-fit px-4">
                    ...
                    <div class="relative">
                        <div class="absolute inset-y-0 start-0 flex items-center ps-3 pointer-events-none">
                            <svg class="w-4 h-4 text-[#58a444] dark:text-white" aria-hidden="true"
                        ...
                        <input type="search" name="search" id="search"
                            class="block w-full p-2 ps-10 text-sm text-[#58a444] dark:text-white dark:placeholder:text-white dark:bg-[#30373F] rounded-lg"
