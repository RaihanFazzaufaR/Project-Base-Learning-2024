            ...
            <div class=" gap-11  w-full h-full">
                ...
                <form action="{{ route('storeSkKematian') }}" method="post" class="gap-4 flex flex-col h-fit">
                    ...
                    <div class="gap-2 flex w-full h-fit mt-4">
                        <div class="basis-1/4 h-full ps-8 flex my-auto items-center">
                            <label for="nomor_kk" class="text-lg font-bold items-center flex w-full text-[#2d5523] dark:text-white">No.
                                KK</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center relative">
                            <input id="nomor_kk" name="nomor_kk" value="{{ Auth::user()->penduduk->kartuKeluarga->niKeluarga }}" readonly class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 pr-10 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <div class="absolute inset-y-0 right-0 flex items-center pr-2 text-sm text-[#34662C] dark:text-gray-400">
                                <span>(No.KK)</span>
                            </div>
                        </div>
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        <div class="basis-1/4 h-full ps-8  flex my-auto items-center">
                            <label for="nama_pelapor" class="text-lg font-bold items-center flex w-full  text-[#2d5523] dark:text-white">nama
                                Pelapor</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center">
                            <input id="nama_pelapor" name="nama_pelapor" placeholder="Masukkan Nama Pelapor Kematian" class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold  text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        <div class="basis-1/4 h-full ps-8  flex my-auto items-center">
                            <label for="hubungan_pelapor" class="text-lg font-bold items-center flex w-full  text-[#2d5523] dark:text-white">Hubungan
                                Pelapor</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center">
                            <input id="hubungan_pelapor" name="hubungan_pelapor" placeholder="Masukkan Hubungan Pelapor dengan yang Meninggal" class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold  text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            {{-- <input type="hidden" id="id_penduduk" name="id_penduduk" value="{{ Auth::user()->penduduk->id_penduduk }}"> --}}
                        </div>
                    </div>
                    {{-- Penyebab Kematian --}}
                    <div class="gap-2 flex w-full h-fit">
                        <div class="basis-1/4 h-full ps-8  flex my-auto items-center">
                            <label for="penyebab_wafat" class="text-lg font-bold items-center flex w-full  text-[#2d5523] dark:text-white">Penyebab
                                Kematian</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center">
                            <input id="penyebab_kematian" name="penyebab_kematian" placeholder="Masukkan Penyebab Kematian" class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold  text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            {{-- <input type="hidden" id="id_penduduk" name="id_penduduk" value="{{ Auth::user()->penduduk->id_penduduk }}"> --}}
                        </div>
                    </div>
                    {{-- Tempat Meninggal --}}
                    <div class="gap-2 flex w-full h-fit">
                        <div class="basis-1/4 h-full ps-8  flex my-auto items-center">
                            <label for="tempat_meninggal" class="text-lg font-bold items-center flex w-full  text-[#2d5523] dark:text-white">Tempat
                                Meninggal</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center">
                            <input id="tempat_meninggal" name="tempat_meninggal" placeholder="Masukkan Tempat Meninggal" class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold  text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            {{-- <input type="hidden" id="id_penduduk" name="id_penduduk" value="{{ Auth::user()->penduduk->id_penduduk }}"> --}}
                        </div>
                    </div>
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        <div class="basis-1/4 h-full ps-8  flex my-auto items-center">
                            <label for="tanggal_wafat" class="text-lg font-bold items-center flex w-full  text-[#2d5523] dark:text-white">Tanggal
                                dan Waktu Meninggal</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center">
                            <input id="tanggal_wafat" name="tanggal_wafat" type="datetime-local" class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold  text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-[46%] p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            {{-- <input type="hidden" id="id_penduduk" name="id_penduduk" value="{{ Auth::user()->penduduk->id_penduduk }}"> --}}
                        </div>
                    </div>
