        ...
        <div class="basis-3/4 w-full h-full">
            <div class=" gap-11  w-full h-full">
                ...
                <form action="{{ route('storeSk') }}" method="post" class="gap-4 flex flex-col h-fit">
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        <div class="basis-1/4 h-full ps-8  flex my-auto items-center">
                            <label for="agama" class="text-lg font-bold items-center flex w-full  text-[#2d5523] dark:text-white">Agama</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center relative">
                            <input id="agama" name="agama" value="{{ Auth::user()->penduduk->agama }}" readonly class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold  text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <div class="absolute inset-y-0 right-0 flex items-center pr-2 text-sm text-[#34662C] dark:text-gray-400">
                                <span>(Agama)</span>
                            </div>
                        </div>
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        ...
                        <div class="basis-3/4 h-full flex items-center relative">
                            <input id="Pekerjaan" name="Pekerjaan" value="{{ Auth::user()->penduduk->pekerjaan }}" readonly readonly class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold  text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <div class="absolute inset-y-0 right-0 flex items-center pr-2 text-sm text-[#34662C] dark:text-gray-400">
                                <span>(Pekerjaan)</span>
                            </div>
                        </div>
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        <div class="basis-1/4 h-full ps-8  flex my-auto items-center">
                            <label for="noKTP" class="text-lg font-bold items-center flex w-full  text-[#2d5523] dark:text-white">No.KTP</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center relative">
                            <input id="noKTP" name="noKTP" value="{{ Auth::user()->penduduk->nik }}" readonly class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold  text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <div class="absolute inset-y-0 right-0 flex items-center pr-2 text-sm text-[#34662C] dark:text-gray-400">
                                <span>(NIK)</span>
                            </div>
                        </div>
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        ...
                        <div class="basis-3/4 h-full flex items-center relative">
                            <input id="alamat" name="alamat" cols="19" rows="3" value="{{ Auth::user()->penduduk->kartuKeluarga->alamat }}" readonly class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold  text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"></textarea>
                            <div class="absolute inset-y-0 right-0 flex items-center pr-2 text-sm text-[#34662C] dark:text-gray-400">
                                <span>(Alamat)</span>
                            </div>
                        </div>
