...
<div class="w-[100%] relative lg:flex hidden justify-center items-center">
    ...
    <div
        ...
        <p class="text-[#2d5523] dark:text-white font-sans text-[32px] text-center">Mudahkan Akses Surat di Lingkungan RW
        </p>
    </div>
</div>
<div
    ...
    <div class="w-[90%] mx-auto gap-4 flex flex-col">
        <div class="lg:hidden text-2xl sm:text-4xl flex flex-col gap-2">
            ...
            <p class="text-[#2d5523] dark:text-white font-sans sm:text-lg text-sm text-left">Mudahkan Akses Surat di
                Lingkungan RW</p>
        ...
        <div class="lg:basis-3/4 w-full h-full">
            <div class=" gap-11  w-full h-full border-2 dark:border-gray-500 rounded-xl">
                ...
                <form action="{{ route('storeSkPindah') }}" method="post"
                    class="gap-4 flex flex-col h-fit sm:p-8 sm:w-[100%] w-[90%] mx-auto">
                    @csrf
                    {{-- nama --}}
                    ...
                    <div class="gap-2 flex w-full flex-col sm:flex-row h-fit">
                        ...
                        <div class="basis-3/4 h-full flex items-center relative">
                            <textarea id="alamat-asal" name="alamat-asal" value="" readonly
                    ...
                    <div class="gap-2 flex w-full flex-col sm:flex-row h-fit">
                        <div class="basis-1/4 h-full sm:ps-8  flex ">
                            <label for="pengikut"
                                class="sm:text-lg text-base sm:font-bold font-semibold items-center flex w-full  text-[#2d5523] dark:text-white">Pengikut
                                / Keluarga Yang
                                Pindah</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center">
