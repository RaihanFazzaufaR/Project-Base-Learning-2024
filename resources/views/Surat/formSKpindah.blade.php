        ...
        <div class="basis-1/4 items-center flex-col ">
            ...
            <div class=" p-2 border-2 rounded-sm">
                <ul class="grid w-full">
                    <li onclick="location.href='{{ route('suratPindah') }}'" class=" {{ $subMenu == 'SK'?'bg-yellow-500 text-white':'text-[#2d5523] bg-white' }} inline-flex pl-3 items-center justify-between w-full p-1.5  border border-gray-200 cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:border-[#2d5523] peer-checked:text-white peer-checked:bg-yellow-500 hover:text-white hover:bg-yellow-500 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                        <div class="block">
                ...
                <ul class="grid w-full">
                    <li onclick="location.href='{{ route('sk-pindah') }}'" class="{{ $subMenu == 'SKP'?'bg-yellow-500 text-white':'text-[#2d5523] bg-white' }} inline-flex pl-3 items-center justify-between w-full p-1.5 border border-gray-200 cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:border-[#2d5523] peer-checked:text-white peer-checked:bg-yellow-500 hover:text-white hover:bg-yellow-500 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                        <div class="block">
                            <div class="w-full text-lg font-semibold">
                ...
                <ul class="grid w-full">
                    <li onclick="location.href='{{ route('sk-kematian') }}'" class="{{ $subMenu == 'SKK'?'bg-yellow-500 text-white':'text-[#2d5523] bg-white' }} inline-flex pl-3 items-center justify-between w-full p-1.5 border border-gray-200 cursor-pointer dark:hover:text-gray-300 dark:border-gray-700 dark:peer-checked:text-blue-500 peer-checked:border-[#2d5523] peer-checked:text-white peer-checked:bg-yellow-500 hover:text-white hover:bg-yellow-500 dark:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700">
                        <div class="block">
                            <div class="w-full text-lg font-semibold">
                ...
                <form action="{{ route('storeSkPindah') }}" method="post" class="gap-4 flex flex-col h-fit">
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        ...
                        <div class="basis-3/4 h-full flex items-center relative">
                            ...
                            <div class="absolute inset-y-0 right-0 flex items-center pr-2 text-sm text-[#34662C] dark:text-gray-400">
                                <span>(Nama)</span>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        <div class="basis-1/4 h-full ps-8  flex my-auto items-center">
                            <label for="nik" class="text-lg font-bold items-center flex w-full  text-[#2d5523] dark:text-white">NIK</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center relative">
                            <input id="nik" name="nik" value="{{ Auth::user()->penduduk->nik }}" readonly class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold  text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <div class="absolute inset-y-0 right-0 flex items-center pr-2 text-sm text-[#34662C] dark:text-gray-400">
                                <span>(NIK)</span>
                            </div>
                        </div>
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        <div class="basis-1/4 h-full ps-8  flex my-auto items-center">
                            <label for="jk" class="text-lg font-bold items-center flex w-full  text-[#2d5523] dark:text-white">Jenis
                                Kelamin</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center relative">
                            <input id="jk" name="jk" value="{{ Auth::user()->penduduk->jenisKelamin === 'L' ? 'Laki-laki' : 'Perempuan' }}" readonly class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold  text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <div class="absolute inset-y-0 right-0 flex items-center pr-2 text-sm text-[#34662C] dark:text-gray-400">
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        <div class="basis-1/4 h-full ps-8  flex my-auto items-center">
                            <label for="ttl" class="text-lg font-bold items-center flex w-full  text-[#2d5523] dark:text-white">Tempat,
                                Tanggal Lahir</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center relative">
                            <input id="ttl" name="ttl" value="{{ Auth::user()->penduduk->tempatLahir }}, {{ Auth::user()->penduduk->tanggalLahir }}" readonly class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold  text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <div class="absolute inset-y-0 right-0 flex items-center pr-2 text-sm text-[#34662C] dark:text-gray-400">
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        <div class="basis-1/4 h-full ps-8  flex my-auto items-center">
                            <label for="warganegara" class="text-lg font-bold items-center flex w-full  text-[#2d5523] dark:text-white">Warganegara
                                / Agama</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center relative">
                            <input id="warganegara" name="warganegara" value="{{ Auth::user()->penduduk->warganegara }} / {{ Auth::user()->penduduk->agama }}" readonly class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold  text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <div class="absolute inset-y-0 right-0 flex items-center pr-2 text-sm text-[#34662C] dark:text-gray-400">
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        <div class="basis-1/4 h-full ps-8  flex my-auto items-center">
                            <label for="pekerjaan" class="text-lg font-bold items-center flex w-full  text-[#2d5523] dark:text-white">Pekerjaan</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center relative">
                            <input id="pekerjaan" name="pekerjaan" value="{{ Auth::user()->penduduk->pekerjaan }}" readonly class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold  text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            {{-- <input type="hidden" id="id_penduduk" name="id_penduduk" value="{{ Auth::user()->penduduk->id_penduduk }}"> --}}
                            <div class="absolute inset-y-0 right-0 flex items-center pr-2 text-sm text-[#34662C] dark:text-gray-400">
                                <span>(Pekerjaan)</span>
                            </div>
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        <div class="basis-1/4 h-full ps-8  flex my-auto items-center">
                            <label for="statuspernikahan" class="text-lg font-bold items-center flex w-full  text-[#2d5523] dark:text-white">Status
                                Pernikahan</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center relative">
                            <input id="statuspernikahan" name="statuspernikahan" value="{{ Auth::user()->penduduk->statusNikah . ' Menikah' }}" readonly class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold  text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <div class="absolute inset-y-0 right-0 flex items-center pr-2 text-sm text-[#34662C] dark:text-gray-400">
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        <div class="basis-1/4 h-full ps-8  flex my-auto items-center">
                            <label for="alamat-asal" class="text-lg font-bold items-center flex w-full  text-[#2d5523] dark:text-white">Alamat-asal</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center relative">
                            <input id="alamat-asal" name="alamat-asal" value="{{ Auth::user()->penduduk->kartukeluarga->alamat }}" readonly class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold  text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                            <div class="absolute inset-y-0 right-0 flex items-center pr-2 text-sm text-[#34662C] dark:text-gray-400">
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        <div class="basis-1/4 h-full ps-8 flex my-auto items-center">
                            <label for="alamat-pindah" class="text-lg font-bold items-center flex w-full text-[#2d5523] dark:text-white">
                                Alamat Pindah
                            </label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center relative">
                            <input id="alamat-pindah" name="alamat-pindah" placeholder="Masukkan Alamat Pindah" class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        </div>
                    </div>
                    <div class="gap-2 flex w-full h-fit mt-4">
                        ...
                        <div class="basis-1/4 h-full flex items-center">
                            <select name="rt" id="rt" class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                        ...
                        <div class="basis-1/4 h-full flex items-center">
                            <select name="rw" id="rw" class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required>
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        <div class="basis-1/4 h-full ps-8 flex my-auto items-center">
                            <label for="keluarga-pindah" class="text-lg font-bold items-center flex w-full text-[#2d5523] dark:text-white">Keluarga
                                yang pindah</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center">
                            <input id="keluarga-pindah" name="keluarga-pindah" type="number" min="1" value="0" readonly placeholder="Masukkan Jumlah Anggota Keluarga yang Pindah" class="bg-white border-2 border-[#2d5523] text-[#2d5523] shadow-md placeholder-[#34662C]/50 font-semibold text-lg rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500">
                        </div>
                    </div>
                    ...
                    <div class="gap-2 flex w-full h-fit">
                        <div class="basis-1/4 h-full ps-8  flex ">
                            <label for="pengikut" class="text-lg font-bold  w-full text-[#2d5523] dark:text-white">Pengikut/Keluarga Yang Pindah</label>
                        </div>
                        <div class="basis-3/4 h-full flex items-center">
                                                ...
                                                <div class=" flex rounded-lg border-2 border-[#2d5523] dark:border-gray-600 border-stroke py-2 pl-3 pr-3 outline-none transition focus:border-primary active:border-primary dark:border-form-strokedark dark:bg-form-input">
                                                    <div class="flex flex-auto flex-wrap gap-3">
                                                        ...
                                                        <div x-show="selected.length == 0" class="flex-1 ">
                                                            <input placeholder="Pilih Anggota Keluarga yang Pindah" class=" placeholder-[#2d5523] dark:bg-[#505c6a] dark:placeholder-white w-full focus:outline-none appearance-none" :value="selectedValues()" />
                                                        </div>
                                                    </div>
