...
<div class=" min-h-[100vh] lg:px-50 lg:py-12 lg:w-[100%] w-[90%] mx-auto py-14">
    <div class="w-full   h-fit">
        <div id="accordion-flush" data-accordion="collapse" data-active-classes="bg-white dark:bg-[#24292d] text-[#2d5523] dark:text-white" data-inactive-classes="text-[#4c8540] dark:text-gray-400">
                    ...
                    <div class="flex flex-col  h-full my-auto items-center justify-center">
                        <div class="py-5 flex flex-col gap-2  h-full">
                            ...
                            <div class="h-full flex items-start pt-5 " x-data="{ 'editModal': false }" @keydown.escape="editModal = false">
                                <button @click="editModal = true" class="bg-[#2d5523] dark:bg-[#57ba47] dark:hover:bg-[#4ea840] hover:bg-[#1d3018] text-white px-5 py-2 rounded-md">
                                    Edit Akun
                                </button>
                                <div x-show="editModal" x-cloak tabindex="-1" aria-hidden="true" class="flex overflow-hidden fixed top-0 right-0 left-0 z-999 justify-center items-center w-full md:inset-0 h-full">
                                    ...
                                    <div class="relative z-[1000] p-4 w-fit max-w-3xl max-h-[700px]" @click.away="editModal = false" x-transition:enter="motion-safe:ease-out duration-300" x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100">
                                        ...
                                        <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                            <!-- Modal header -->
                                            <div class="flex h-[75px] items-center justify-between px-4 md:px-5 border-b-2 rounded-t border-[#2d5523] dark:border-white">
                                            ...
                                            <!-- Modal body -->
                                            <form class="w-full h-fit text-[#34662C] dark:text-white" method="POST" action="{{ route('update') }}">
                                                @csrf
                                                <div class="p-4 md:p-5 grid w-150 gap-4 grid-cols-2 max-h-[450px] overflow-y-auto rounded-b-xl">
                                                    <div class="col-span-2 relative">
                                                        ...
                                                        <input name="username" class="bg-white dark:bg-[#505c6a] shadow-md border border-[#34662C] dark:border-gray-600 text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C]" placeholder="Masukkan Username" value="{{ $penduduk->userAccount->username }}">
                                                    </div>
                                                    <div class="col-span-2 relative">
                                                        <label for="level" class="block mb-2 text-sm font-bold">Password Lama</label>
                                                        <input id="pw-lama" name="pw-lama" type="password" class="bg-white dark:text-white dark:bg-[#505c6a] shadow-md border border-[#34662C] dark:border-gray-600 text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white" placeholder="Masukkan password lama" value="">
                                                    ...
                                                    <div class="col-span-2 relative">
                                                        ...
                                                        <input id="pw-baru" name="pw-baru" type="password" class="bg-white dark:text-white dark:bg-[#505c6a] shadow-md border border-[#34662C] dark:border-gray-600 text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white" placeholder="Kosongkan jika tidak ada perubahan password" value="">
                                                        <button type="button" id="pw-baru-show" class="absolute right-3 bottom-3" onclick="showPassword('pw-baru')">
                                                            <i class=" fa-solid fa-eye-slash text-lg"></i>
                                                        </button>
                                                    </div>
                                                </div>
                                                <div class="flex items-center justify-end bg-[#F2F2F2] dark:bg-[#343b44] gap-4 h-[75px] px-4 md:px-8 border-b-2 rounded-t border-[#B8B8B8]">
                                                    <button @click="editModal = false" class="hover:text-white inline-flex px-4 py-2 text-sm font-bold rounded-lg shadow-md items-center hover:bg-[#34662C] bg-white text-[#34662C] hover:scale-105 transition duration-300 ease-in-out dark:bg-white dark:hover:bg-white dark:text-[#2d5523]">
                                                        Batal
                                                    </button>
            ...
            <div class="w-full">
                <h2 id="accordion-flush-heading-2">
                    <button type="button" class="flex items-center justify-between w-full py-5 text-2xl rtl:text-right text-[#4c8540] font-bold border-b-2 border-gray-200  dark:border-gray-500 dark:text-gray-400 gap-3" data-accordion-target="#accordion-flush-body-2" aria-expanded="false" aria-controls="accordion-flush-body-2">
                                ...
                                <div class="basis-1/2 ">
                                    <div class="grid gap-4 sm:grid-cols-2 pb-3 sm:gap-6">
                                        <div class="sm:col-span-2">
                                            ...
                                            <input type="text" name="nama" id="nama" class="bg-gray-50 border text-base border-[#518742]  text-[#2f5724] rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#505c6a] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type product name" required="" readonly value="{{ $penduduk->nama }}">
                                        </div>
                                    </div>
                                    <div class="grid gap-4 sm:grid-cols-2 pb-3 sm:gap-6">
                                        <div class="sm:col-span-2">
                                            <label for="nik" class="block mb-2 text-sm font-medium text-[#2d5523] dark:text-white">NIK</label>
                                            <input type="text" name="nik" id="nik" class="bg-gray-50 border text-base border-[#518742]  text-[#2f5724] rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#505c6a] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type product name" required="" readonly value="{{ $penduduk->nik }}">
                                        </div>
                                    </div>
                                    <div class="grid gap-4 sm:grid-cols-2 pb-3 sm:gap-6">
                                        <div class="sm:col-span-2">
                                            <label for="nkk" class="block mb-2 text-sm font-medium text-[#2d5523] dark:text-white">NKK</label>
                                            <input type="text" name="nkk" id="nkk" class="bg-gray-50 border text-base border-[#518742]  text-[#2f5724] rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#505c6a] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type product name" required="" readonly value="{{  $penduduk->kartuKeluarga->niKeluarga }}">
                                        </div>
                                    </div>
                                    <div class="grid gap-4 sm:grid-cols-2 pb-3 sm:gap-6">
                                        <div class="sm:col-span-2">
                                            <label for="email" class="block mb-2 text-sm font-medium text-[#2d5523] dark:text-white">Email</label>
                                            <input type="text" name="email" id="email" class="bg-gray-50 border text-base border-[#518742]  text-[#2f5724] rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#505c6a] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type product name" required="" readonly value="{{ $penduduk->userAccount->email }}">
                                        </div>
                                    </div>
                                    <div class="grid gap-4 sm:grid-cols-2 pb-3 sm:gap-6">
                                        <div class="sm:col-span-2">
                                            <label for="ttl" class="block mb-2 text-sm font-medium text-[#2d5523] dark:text-white">Tempat,
                                                Tanggal Lahir</label>
                                            <input type="text" name="ttl" id="ttl" class="bg-gray-50 border text-base border-[#518742]  text-[#2f5724] rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#505c6a] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type product name" required="" readonly value="{{ $penduduk->tempatLahir }}, {{ $penduduk->tanggalLahir }}">
                                        </div>
                                    </div>
                                    <div class="grid gap-4 sm:grid-cols-2 pb-3 sm:gap-6">
                                        <div class="sm:col-span-2">
                                            <label for="jenis-kelamin" class="block mb-2 text-sm font-medium text-[#2d5523] dark:text-white">Jenis
                                                Kelamin</label>
                                            <input type="text" name="jenis-kelamin" id="jenis-kelamin" class="bg-gray-50 border text-base border-[#518742]  text-[#2f5724] rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#505c6a] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type product name" required="" readonly value="{{ $penduduk->jenisKelamin == 'L' ? 'Laki-laki' : ($penduduk->jenisKelamin == 'P' ? 'Perempuan' : '') }}">
                                        </div>
                                    </div>
                                ...
                                <div class="basis-1/2">
                                    <div class="grid gap-4 sm:grid-cols-2 pb-3 sm:gap-6">
                                        <div class="sm:col-span-2">
                                            ...
                                            <input type="text" name="agama" id="agama" class="bg-gray-50 border text-base border-[#518742]  text-[#2f5724] rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#505c6a] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type product name" required="" readonly value="{{ Str::ucfirst($penduduk->agama) }}">
                                        </div>
                                    </div>
                                    <div class="grid gap-4 sm:grid-cols-2 pb-3 sm:gap-6">
                                        <div class="sm:col-span-2">
                                            <label for="pekerjaan" class="block mb-2 text-sm font-medium text-[#2d5523] dark:text-white">Pekerjaan</label>
                                            <input type="text" name="pekerjaan" id="pekerjaan" class="bg-gray-50 border text-base border-[#518742]  text-[#2f5724] rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#505c6a] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type product name" required="" readonly value="{{ Str::ucfirst($penduduk->pekerjaan) }}">
                                        </div>
                                    </div>
                                    <div class="grid gap-4 sm:grid-cols-2 pb-3 sm:gap-6">
                                        <div class="sm:col-span-2">
                                    ...
                                    <div class="grid gap-4 sm:grid-cols-2 pb-3 sm:gap-6">
                                        <div class="sm:col-span-2">
                                            <label for="status-pernikahan" class="block mb-2 text-sm font-medium text-[#2d5523] dark:text-white">Status
                                                pernikahan</label>
                                            <input type="text" name="status-pernikahan" id="status-pernikahan" class="bg-gray-50 border text-base border-[#518742]  text-[#2f5724] rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#505c6a] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" placeholder="Type product name" required="" readonly value="{{ Str::ucfirst($penduduk->statusNikah) }} Menikah">
                                        </div>
                                    </div>
                                    <div class="grid gap-4 sm:grid-cols-2 pb-3 sm:gap-6">
                                        <div class="sm:col-span-2">
                                            <label for="alamat" class="block mb-2 text-sm font-medium text-[#2d5523] dark:text-white">Alamat</label>
                                            <textarea name="alamat" id="alamat" rows="5" class="bg-gray-50 border text-base  border-[#518742]  text-[#2f5724] rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5 dark:bg-[#505c6a] dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500" required="" readonly>{{ $penduduk->kartuKeluarga->alamat }}</textarea>
