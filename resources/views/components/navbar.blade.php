<nav class="sticky top-0 z-[99] bg-white border-gray-200 dark:bg-gray-900 border-b-4 lg:h-[10vh]">
        <div class="max-w-full flex flex-wrap items-center justify-between lg:mx-12 mx-8 py-4">
          ...
          <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse md:gap-5">
            ...
            <button type="button" class="flex text-sm bg-gray-800 rounded-full md:me-0 focus:ring-4 focus:ring-gray-300 dark:focus:ring-gray-600" id="user-menu-button" aria-expanded="false" data-dropdown-toggle="user-dropdown" data-dropdown-placement="bottom">
              ...
              <img class="w-8 h-8 rounded-full" src="{{ asset('assets/images/profile.png') }}" alt="user photo">
            </button>
            <!-- Dropdown menu -->
