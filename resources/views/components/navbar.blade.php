<nav class="sticky top-0 z-[99] print:hidden bg-white border-gray-200 dark:bg-gray-900 border-b-2 h-fit" id="navbar"
    data-aos="fade-down" data-aos-duration="1000" data-aos-once="true" style="transition: all 0.5s">
    ...
    <div class="max-w-full flex flex-wrap items-center justify-between lg:mx-12 mx-8 py-4">
        ...
        <div class="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse md:gap-5">
            ...
            <div id="dropdownNotification"
                class="z-20 hidden w-full max-h-70 overflow-y-auto !absolute !-left-10 !top-5 max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow dark:bg-gray-800 dark:divide-gray-700"
            ...
            @if (Auth::check())
                <button type="button"
                    ...
                    <img class="w-9 h-9 rounded-full" src="{{ asset('assets/images/userProfile.png') }}"
                        alt="user photo">
                </button>
                <!-- Dropdown menu -->
                <div class="z-50 hidden !my-3 !-ml-5 text-base list-none bg-white divide-y divide-gray-100 rounded-lg overflow-hidden shadow dark:bg-gray-700 dark:divide-gray-600"
                    id="user-dropdown">
                    <div class="px-4 py-3">
                        <span
                            class="block text-sm font-semibold text-gray-900">{{ Auth::user()->penduduk->nama }}</span>
            ...
            @else
                <a href="{{ route('login') }}"
                    class="py-1 px-5 bg-[#34662C] shadow-md rounded-2xl text-lg font-semibold text-white hover:bg-white hover:text-[#34662C] border-2 border-transparent hover:border-[#34662C] transition ease-in-out duration-200">Masuk</a>
            @endif
        ...
        <div class="items-center justify-between hidden w-full md:flex md:w-auto md:order-1" id="navbar-user">
            <ul
                class="flex flex-col font-bold p-4 md:p-0 mt-4 border border-gray-100 rounded-lg bg-gray-50 md:space-x-8 rtl:space-x-reverse md:flex-row md:mt-0 md:border-0 md:bg-transparent dark:bg-gray-800 md:dark:bg-transparent dark:border-gray-700">
                <li>
                    <a href="{{ url('/') }}"
                        class="block py-2 px-3 text-white bg-blue-700 rounded md:bg-transparent md:hover:text-[#1C4F0F] md:p-0 md:relative group {{ $menu === 'Home' ? 'md:text-[#1C4F0F]' : 'md:text-gray-500' }}">
                        Home
                        <div
                            class="md:absolute md:h-[2.5px] md:w-full md:bg-[#1C4F0F]  group-hover:scale-x-100 md:transition md:ease-in-out md:duration-500 {{ $menu === 'Home' ? '' : 'md:scale-x-0' }}">
                        </div>
                    </a>
                </li>
                <li>
                    <button id="dropdownUmkmLink" data-dropdown-toggle="dropdownUmkm"
                        class="flex items-center justify-between w-full py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#1C4F0F] md:p-0 md:relative group {{ $menu === 'UMKM' || $menu === 'UMKMKU' ? 'md:text-[#1C4F0F]' : 'md:text-gray-500' }}">
                        UMKM
                        ...
                        <div
                            class="md:absolute md:h-[2.5px] md:w-full md:bg-[#1C4F0F] -bottom-1 group-hover:scale-x-100 md:transition md:ease-in-out md:duration-500 {{ $menu === 'UMKM' || $menu === 'UMKMKU' ? '' : 'md:scale-x-0' }}">
                        </div>
                    </button>
                    <!-- Dropdown menu -->
                    <div id="dropdownUmkm"
                        class="z-10 hidden font-normal overflow-hidden bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700 dark:divide-gray-600">
                        <ul class="text-sm font-semibold text-gray-700 dark:text-gray-400 "
                ...
                <li>
                    <a href="{{ route('jadwal') }}"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#1C4F0F] md:p-0 md:relative group {{ $menu === 'Kegiatan' ? 'md:text-[#1C4F0F]' : 'md:text-gray-500' }}">
                        Kegiatan
                        <div
                            class="md:absolute md:h-[2.5px] md:w-full md:bg-[#1C4F0F]  group-hover:scale-x-100 md:transition md:ease-in-out md:duration-500 {{ $menu === 'Kegiatan' ? '' : 'md:scale-x-0' }}">
                        </div>
                    </a>
                </li>
                <li>
                    <a href="{{ route('penduduk') }}"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#1C4F0F] md:p-0 md:relative group {{ $menu === 'Penduduk' ? 'md:text-[#1C4F0F]' : 'md:text-gray-500' }}">
                        Penduduk
                        <div
                            class="md:absolute md:h-[2.5px] md:w-full md:bg-[#1C4F0F]  group-hover:scale-x-100 md:transition md:ease-in-out md:duration-500 {{ $menu === 'Penduduk' ? '' : 'md:scale-x-0' }}">
                        </div>
                    </a>
                </li>
                <li>
                    <button id="dropdownSuratLink" data-dropdown-toggle="dropdownSurat"
                        class="flex items-center justify-between w-full py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#1C4F0F] md:p-0 md:relative group {{ $menu === 'Surat' || $menu === 'Suratku' ? 'md:text-[#1C4F0F]' : 'md:text-gray-500' }}">
                        Surat
                        <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div
                            class="md:absolute md:h-[2.5px] md:w-full md:bg-[#1C4F0F] -bottom-1 group-hover:scale-x-100 md:transition md:ease-in-out md:duration-500 {{ $menu === 'Surat' || $menu === 'Suratku' ? '' : 'md:scale-x-0' }}">
                        </div>
                    </button>
                    <!-- Dropdown menu -->
                ...
                <li>
                    <a href="{{ route('bansos') }}"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#1C4F0F] md:p-0 md:relative group {{ $menu === 'Bansos' ? 'md:text-[#1C4F0F]' : 'md:text-gray-500' }}">
                        Bansos
                        <div
                            class="md:absolute md:h-[2.5px] md:w-full md:bg-[#1C4F0F]  group-hover:scale-x-100 md:transition md:ease-in-out md:duration-500 {{ $menu === 'Bansos' ? '' : 'md:scale-x-0' }}">
                        </div>
                    </a>
                </li>
                <li>
                    <button id="dropdownAduanLink" data-dropdown-toggle="dropdownAduan"
                        class="flex items-center justify-between w-full py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#1C4F0F] md:p-0 md:relative group {{ $menu === 'Aduan' || $menu === 'Aduan-Ku' ? 'md:text-[#1C4F0F]' : 'md:text-gray-500' }}">
                        Aduan
                        <svg class="w-2.5 h-2.5 ms-2.5" aria-hidden="true" xmlns="http://www.w3.org/2000/svg"
                            fill="none" viewBox="0 0 10 6">
                            <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
                        ...
                        <div
                            class="md:absolute md:h-[2.5px] md:w-full md:bg-[#1C4F0F] -bottom-1 group-hover:scale-x-100 md:transition md:ease-in-out md:duration-500 {{ $menu === 'Aduan' || $menu === 'Aduanku' ? '' : 'md:scale-x-0' }}">
                        </div>
                    </button>
                    {{-- Dropdown menu --}}
          ...
          <div class="md:absolute md:h-[2.5px] md:w-full md:bg-[#1C4F0F]  group-hover:scale-x-100 md:transition md:ease-in-out md:duration-500 {{ ($menu === 'Aduan') ? '':'md:scale-x-0' }}"></div>
                ...
                <li>
                    <a href="{{ route('profil') }}"
                        class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 md:hover:bg-transparent md:hover:text-[#1C4F0F] md:p-0 md:relative group {{ $menu === 'Profil' ? 'md:text-[#1C4F0F]' : 'md:text-gray-500' }}">
                        Profil
                        <div
                            class="md:absolute md:h-[2.5px] md:w-full md:bg-[#1C4F0F]  group-hover:scale-x-100 md:transition md:ease-in-out md:duration-500 {{ $menu === 'Profil' ? '' : 'md:scale-x-0' }}">
                        </div>
                    </a>
                </li>
            </ul>
