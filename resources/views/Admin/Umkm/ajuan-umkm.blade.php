                                                    ...
                                                    <form action="{{ route('umkm.reject') }}" method="POST">
                                                        ...
                                                        <div class="p-4 md:p-5 grid w-150 gap-4 grid-cols-2 max-h-[450px] overflow-y-auto rounded-b-xl">
                                                            <div class="col-span-2">
                                                                ...
                                                                <textarea id="alasan" name="alasan" rows="4" class="bg-white shadow-md border border-[#34662C] text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C]" placeholder="Masukkan Alasan Penolakan..."></textarea>
                                                                <input type="hidden" id="umkm_id" name="umkm_id" value="{{ $umkm->umkm_id }}">
                                                            </div>
                                                        </div>
                                                    </form>
