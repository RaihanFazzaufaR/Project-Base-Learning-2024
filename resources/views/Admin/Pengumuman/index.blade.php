                            ...
                            <div
                                ...
                                <div class="col-span-2">
                                    ...
                                    <textarea name="lokasi" rows="4" id="lokasi"
                                        class="bg-white shadow-md border border-[#34662C] text-sm dark:border-gray-500 dark:bg-[#505c6a] rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white"></textarea>
                                </div>
                                <div class="col-span-2">
                        ...
                        <tr
                            ...
                            <td>
                                <div class="px-6 py-4 flex gap-4 justify-center items-center h-full">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="col-span-2 relative sm:col-span-1">
                                                                <label class="block mb-2 text-sm font-bold">Nama
                                                                    Pembuat</label>
                                                                <input name="nama"
                                                                    class="bg-white shadow-md border dark:border-gray-500 dark:bg-[#505c6a] border-[#34662C] text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white"
                                                                    value="{{ $pengumuman->jadwal_id ? $pengumuman->jadwal->penduduk->nama : ($pengumuman->pembuat ? $pengumuman->pembuat->nama : '-') }}"
                                                                    readonly>
                                                            </div>
                                                            <div class="col-span-2 sm:col-span-1">
                                                                <label
                                                                ...
                                                                <input name="kategori" id="kategori"
                                                                    class="bg-white shadow-md border dark:border-gray-500 dark:bg-[#505c6a] border-[#34662C] text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white"
                                                                    required readonly
                                                                    value="{{ $pengumuman->aktivitas_tipe }}">
                                                            </div>
                                                            <div class="col-span-2">
                                                                <label class="block mb-2 text-sm font-bold">Nama
                                                                    Kegiatan</label>
                                                            ...
                                                            <div class="col-span-2 sm:col-span-1">
                                                                <label
                                                                    class="block mb-2 text-sm font-bold">Iuran</label>
                                                                <input type="number" name="iuran" id="iuran"
                                                                    class="bg-white shadow-md border dark:border-gray-500 dark:bg-[#505c6a] border-[#34662C] text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white"
                                                                    required readonly
                                                                    value="{{ $pengumuman->iuran ? $pengumuman->iuran : 0 }}">
                                                            </div>
                                                            <div class="col-span-2">
                                                                <label
                                                                    class="block mb-2 text-sm font-bold">Lokasi</label>
                                                                <textarea name="lokasi" rows="4" id="lokasi"
                                                                    class="bg-white shadow-md border dark:border-gray-500 dark:bg-[#505c6a] border-[#34662C] text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white"
                                                                    required readonly>{{ $pengumuman->lokasi ? $pengumuman->lokasi : '-' }}</textarea>
                                                            </div>
                                                            <div class="col-span-2">
                                                                <label
                                                                ...
                                                                <textarea name="deskripsi" rows="4" id="deskripsi"
                                                                    class="bg-white shadow-md border dark:border-gray-500 dark:bg-[#505c6a] border-[#34662C] text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white"
                                                                    required readonly>{{ $pengumuman->konten }}</textarea>
                                                            </div>
                                                        </div>
                                                        <div
                                                            class="flex items-center justify-center sm:justify-between bg-[#F2F2F2] dark:bg-[#3e4852] gap-4 sm:h-[75px] h-[65px] px-4 md:px-8 border-b-2 rounded-t border-[#B8B8B8] dark:border-gray-500 rounded-b-md">
                                                            <p>{{ $pengumuman->sent_at ? 'Pesan Terkirim' : 'Pesan Belum Terkirim' }}
                                                            </p>
                                                            <button @click="detailModal = false"
                                                                class="hover:text-white inline-flex sm:px-4 px-30 py-2 text-sm font-bold rounded-lg shadow-md items-center hover:bg-[#34662C] bg-white text-[#34662C] hover:scale-105 transition duration-300 ease-in-out">
                                                                Keluar
                                                            </button>
                                                        </div>
                                                    </div>
                                        ...
                                        <div x-data="{ 'editModal': false }" @keydown.escape="editModal = false">
                                            <div @keydown.escape="editModal = false">
                                                <button @click="editModal = true"
                                                    class="flex justify-center items-center gap-2 w-fit text-white bg-[#FFDE68]  rounded-full sm:rounded-lg shadow-xl font-bold h-full sm:px-3 sm:py-2 p-2 hover:bg-[#B39C49] hover:scale-105 transition-all">
                                                ...
                                                <div class="relative z-[1000] sm:p-4 w-full sm:w-fit sm:max-w-3xl max-h-[700px]"
                                                    ...
                                                    <div class="relative bg-white rounded-lg shadow dark:bg-[#2F363E]">
                                                        ...
                                                        <form
                                                            class="w-full h-full text-[#34662C] dark:text-white text-left"
                                                            method="POST"
                                                            action="{{ route('update-pengumuman', $pengumuman->pengumuman_id) }}">
                                                            @csrf
                                                            {!! method_field('PUT') !!}
                                                                ...
                                                                <div class="col-span-2 sm:col-span-1">
                                                                    ...
                                                                    <select name="kategori" id="kategori"
                                                                        ...
                                                                        <option value="Kebersihan"
                                                                            @if ($pengumuman->aktivitas_tipe === 'Kebersihan') selected @endif>
                                                                            Kebersihan</option>
                                                                        <option value="Lingkungan"
                                                                            @if ($pengumuman->aktivitas_tipe === 'Lingkungan') selected @endif>
                                                                            Lingkungan</option>
                                                                        <option value="Kesehatan"
                                                                            @if ($pengumuman->aktivitas_tipe === 'Kesehatan') selected @endif>
                                                                            Kesehatan</option>
                                                                        <option value="Pendidikan"
                                                                            @if ($pengumuman->aktivitas_tipe === 'Pendidikan') selected @endif>
                                                                            Pendidikan</option>
                                                                        <option value="Budaya"
                                                                            @if ($pengumuman->aktivitas_tipe === 'Budaya') selected @endif>
                                                                            Budaya</option>
                                                                        <option value="Kemanusiaan"
                                                                            @if ($pengumuman->aktivitas_tipe === 'Kemanusiaan') selected @endif>
                                                                            Kemanusiaan</option>
                                                                        <option value="Kuliner"
                                                                            @if ($pengumuman->aktivitas_tipe === 'Kuliner') selected @endif>
                                                                            Kuliner</option>
                                                                        <option value="Ekonomi"
                                                                            @if ($pengumuman->aktivitas_tipe === 'Ekonomi') selected @endif>
                                                                            Ekonomi</option>
                                                                    </select>
                                                                </div>
                                                                <div class="col-span-2">
                                                                    ...
                                                                    <input type="text" name="judul"
                                                                        id="nama"
                                                                        class="bg-white shadow-md border dark:border-gray-500 dark:bg-[#505c6a] border-[#34662C] text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white"
                                                                        required value="{{ $pengumuman->judul }}">
                                                                </div>
                                                                <div class="col-span-2 sm:col-span-1">
                                                                    <label for="tanggal_mulai"
                                                                        class="block mb-2 text-sm font-bold">Tanggal
                                                                        Mulai</label>
                                                                    <input type="date" name="mulai_tanggal"
                                                                        id="mulai_tanggal"
                                                                        class="bg-white shadow-md border dark:border-gray-500 dark:bg-[#505c6a] border-[#34662C] text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white"
                                                                        value="{{ $pengumuman->mulai_tanggal }}">
                                                                </div>
                                                                <div class="col-span-2 sm:col-span-1">
                                                                    <label for="akhir_tanggal"
                                                                        class="block mb-2 text-sm font-bold">Tanggal
                                                                        Selesai</label>
                                                                    <input type="date" name="akhir_tanggal"
                                                                        id="akhir_tanggal"
                                                                        class="bg-white shadow-md border dark:border-gray-500 dark:bg-[#505c6a] border-[#34662C] text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white"
                                                                        value="{{ $pengumuman->akhir_tanggal }}">
                                                                </div>
                                                                <div class="col-span-2 sm:col-span-1">
                                                                    <div class="grid grid-cols-2 gap-2">
                                                                        <div class="col-span-2 sm:col-span-1">
                                                                            <label for="mulai_waktu"
                                                                                class="block mb-2 text-sm font-bold">Jam
                                                                                Mulai</label>
                                                                            <input type="time" name="mulai_waktu"
                                                                                id="mulai_waktu"
                                                                                class="bg-white shadow-md border dark:border-gray-500 dark:bg-[#505c6a] border-[#34662C] text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white"
                                                                                value="{{ $pengumuman->mulai_waktu }}">
                                                                        </div>
                                                                        <div class="col-span-2 sm:col-span-1">
                                                                            <label for="akhir_waktu"
                                                                                class="block mb-2 text-sm font-bold">Jam
                                                                                Selesai</label>
                                                                            <input type="time" name="akhir_Waktu"
                                                                                id="akhir_waktu"
                                                                                class="bg-white shadow-md border dark:border-gray-500 dark:bg-[#505c6a] border-[#34662C] text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white"
                                                                                value="{{ $pengumuman->akhir_waktu }}">
                                                                        </div>
                                                                    </div>
                                                                </div>
                                                                <div class="col-span-2 sm:col-span-1">
                                                                    <label for="iuran"
                                                                        class="block mb-2 text-sm font-bold">Iuran</label>
                                                                    <input type="number" name="iuran"
                                                                        id="iuran"
                                                                        class="bg-white shadow-md border dark:border-gray-500 dark:bg-[#505c6a] border-[#34662C] text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white"
                                                                        value="{{ $pengumuman->iuran }}">
                                                                </div>
                                                                <div class="col-span-2">
                                                                    <label for="lokasi"
                                                                        class="block mb-2 text-sm font-bold">Lokasi</label>
                                                                    <textarea name="lokasi" rows="4" id="lokasi"
                                                                        class="bg-white shadow-md border dark:border-gray-500 dark:bg-[#505c6a] border-[#34662C] text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white">{{ $pengumuman->lokasi }}</textarea>
                                                                </div>
                                                                <div class="col-span-2">
                                                                    <label for="konten"
                                                                        class="block mb-2 text-sm font-bold">Deskripsi</label>
                                                                    <textarea name="konten" rows="4" id="konten"
                                                                        class="bg-white shadow-md border dark:border-gray-500 dark:bg-[#505c6a] border-[#34662C] text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C] dark:placeholder-white"
                                                                        required>{{ $pengumuman->konten }}</textarea>
                                                                </div>
                                                            </div>
                                                            <div
                                                                class="flex items-center justify-center sm:justify-end bg-[#F2F2F2] dark:bg-[#3e4852] gap-4 sm:h-[75px] h-[65px] px-4 md:px-8 border-b-2 rounded-t border-[#B8B8B8] dark:border-gray-500 rounded-b-md">
                                    ...
                                    @endif
                                    <form action="{{ route('destroy-pengumuman', $pengumuman->pengumuman_id) }}"
                                        method="POST">
                                        @csrf
                                        {!! method_field('DELETE') !!}
                                        <button type="submit"
                                            class="flex justify-center items-center gap-2 w-fit text-white bg-[#FF5E5E]  rounded-full sm:rounded-lg shadow-xl font-bold h-full sm:px-3 sm:py-2 p-2 hover:bg-[#B34242] hover:scale-105 transition-all">
