                            ...
                            <div
                                ...
                                <div class="col-span-2">
                                    ...
                                    <textarea name="lokasi" rows="4" id="lokasi"
                                        class="bg-white shadow-md border border-[#34662C] text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C]"></textarea>
                                </div>
                                <div class="col-span-2">
                ...
                <tbody>
                    @foreach ($pengumumans as $pengumuman)
                        <tr
                            ...
                            <td class="px-6 py-4">
                                {{ $pengumuman->jadwal_id != null ? $pengumuman->jadwal->penduduk->nama : $pengumuman->pembuat->nama }}
                            </td>
                            <td class="px-6 py-4">
                                {{ $pengumuman->judul }}
                            </td>
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="col-span-2 relative sm:col-span-1">
                                                                <label class="block mb-2 text-sm font-bold">Nama
                                                                    Pembuat</label>
                                                                <input name="nama"
                                                                    class="bg-white shadow-md border dark:border-gray-500 dark:bg-[#505c6a] border-[#34662C] text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C]"
                                                                    value="{{ $pengumuman->jadwal_id != null ? $pengumuman->jadwal->penduduk->nama : $pengumuman->pembuat->nama }}"
                                                                    readonly>
                                                            </div>
                                                            <div class="col-span-2 sm:col-span-1">
                                                                <label
                                                            ...
                                                            <div
                                                                ...
                                                                <div class="col-span-2">
                                                                    <label for="lokasi"
                                                                        class="block mb-2 text-sm font-bold">Lokasi</label>
                                                                    <textarea name="lokasi" rows="4" id="lokasi"
                                                                        class="bg-white shadow-md border dark:border-gray-500 dark:bg-[#505c6a] border-[#34662C] text-sm rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C]">{{ $pengumuman->lokasi }}</textarea>
                                                                </div>
                                                                <div class="col-span-2">
                                                                    <label for="konten"
                                                                        class="block mb-2 text-sm font-bold">Deskripsi</label>
