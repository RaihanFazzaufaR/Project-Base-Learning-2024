                ...
                <div x-show="filterModal" x-transition:enter="md:transition-none transition ease-out duration-300 transform" x-transition:enter-start="md:transition-none translate-y-full" x-transition:enter-end="md:transition-none translate-y-0" x-transition:leave="md:transition-none transition ease-in duration-300 transform" x-transition:leave-start="md:transition-none translate-y-0" x-transition:leave-end="md:transition-none translate-y-full" tabindex="-1" aria-hidden="true" class="flex overflow-hidden fixed top-0 right-0 left-0 z-999 justify-center sm:items-center items-end w-full md:inset-0 h-full">
                    ...
                    <div class="relative z-[1000] sm:p-4 w-full sm:w-fit sm:max-w-3xl max-h-[700px]" @click.away="detailModal = false" x-transition:enter="motion-safe:ease-out duration-300" x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100">
                        <div class="relative bg-white rounded-lg shadow dark:bg-[#2F363E]">
                            ...
                            <!-- Modal body -->
                            <form class="w-full h-full text-[#34662C] dark:text-white" action="{{ route('pengaduan-admin') }}">
                                @csrf
                                <div class="p-4 d:p-5 grid w-full sm:w-150 gap-4 grid-cols-2 max-h-[400px] sm:max-h-[450px] overflow-y-auto scrollbar-thumb-[#57BA47] scrollbar-track-[#E4F7DF] scrollbar-thin rounded-b-xl">
                                    <div class="col-span-2 sm:col-span-1">
                                        ...
                                        <select id="status" name="status" class="bg-white shadow-md border border-[#34662C] text-sm dark:border-gray-500 dark:bg-[#505c6a] rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C]">
                                    ...
                                    <div class="col-span-2 sm:col-span-1">
                                        ...
                                        <select id="prioritas" name="prioritas" class="bg-white shadow-md border border-[#34662C] text-sm dark:border-gray-500 dark:bg-[#505c6a] rounded-lg focus:outline-none focus:border-2 block w-full p-2.5 placeholder-[#34662C]">
                                ...
                                <div class="flex items-center justify-center sm:justify-end bg-[#F2F2F2] dark:bg-[#3e4852] gap-4 sm:h-[75px] h-[65px] px-4 md:px-8 border-b-2 rounded-t border-[#B8B8B8] dark:border-gray-500 rounded-b-md">
                                    <button type="submit" @click="filterModal = false" class="hover:text-white hidden sm:inline-flex px-4 py-2 text-sm font-bold rounded-lg shadow-md items-center hover:bg-[#34662C] bg-white text-[#34662C] hover:scale-105 transition duration-300 ease-in-out">
                                        Batal
                                    </button>
                                    <button type="submit" @click="filterModal = false" class="text-white inline-flex sm:px-4 px-30 py-2 text-sm font-bold rounded-lg shadow-md items-center bg-[#34662C] hover:bg-white hover:text-[#34662C] hover:scale-105 transition duration-300 ease-in-out">
                                        Filter
                                    </button>
                                </div>
                            </form>
        ...
        <div class="relative shadow-sm rounded-lg overflow-x-auto">
            <table class="w-[600px] sm:w-full text-center table-fixed relative">
                ...
                <tbody>
                    ...
                    <tr class="text-xs bg-white border-b sm:text-sm font-medium text-[#7F7F7F] dark:bg-[#2F363E] dark:text-white dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
                        ...
                        <td class="modal">
                            <div class="px-6 py-4 flex items-center h-full gap-4 justify-center">
                                    ...
                                    <div x-data="{ 'detailModal': idAduan === {{ $complaint->aduan_id }} }" @keydown.escape="detailModal = false">
                                        ...
                                        <div x-show="detailModal" x-transition:enter="md:transition-none transition ease-out duration-300 transform" x-transition:enter-start="md:transition-none translate-y-full" x-transition:enter-end="md:transition-none translate-y-0" x-transition:leave="md:transition-none transition ease-in duration-300 transform" x-transition:leave-start="md:transition-none translate-y-0" x-transition:leave-end="md:transition-none translate-y-full" tabindex="-1" aria-hidden="true" class="flex overflow-hidden fixed top-0 right-0 left-0 z-999 justify-center sm:items-center items-end w-full md:inset-0 h-full">
                                            ...
                                            <div class="relative z-[1000] sm:p-4 w-full sm:w-fit sm:max-w-3xl max-h-[700px] rounded-lg" @click.away="detailModal = false" x-transition:enter="motion-safe:ease-out duration-300" x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100">
                                                <!-- Modal content -->
                                                <div class="relative bg-[#f4f4f4] rounded-lg shadow dark:bg-[#2F363E]">
                                                    <!-- Modal header -->
                                                    <div class="flex h-[75px] items-center justify-between px-4 md:px-5 border-b-2 rounded-t border-[#B8B8B8]">
                                                        <h3 class="text-xl font-bold text-[#34662C] dark:text-white">
                                                            {{ $complaint->judul }}
                                                    ...
                                                    <div class="w-full h-full text-[#34662C] text-left">
                                                        <div class="p-5  w-full sm:w-150">
                                                            ...
                                                            <button class="flex justify-center items-center gap-2 w-8 h-8 {{ $stat[$complaint->status]['classContent'] }}">
                                                                <i class="fa-solid text-lg {{ $stat[$complaint->status]['icon'] }}"></i>
                                                            </button>
                                                            @endif
                                                        </div>
                                                        <div class="max-h-[450px] overflow-y-auto scrollbar-thin pt-3 scrollbar-thumb-[#57BA47] scrollbar-track-[#E4F7DF] chat-div">
                                                            ...
                                                            <div class="flex w-full p-4 {{ Auth::user()->penduduk->id_penduduk == $complaint->pengadu_id ? 'justify-end' : '' }}">
                                                                <div class="p-4 w-fit rounded-lg max-w-[75%] shadow-lg {{ Auth::user()->penduduk->id_penduduk == $complaint->pengadu_id ? 'bg-[#cdffc5] text-black dark:text-white dark:bg-[#005c4b]' : 'bg-white text-black dark:text-white dark:bg-gray-700' }}">
                                                        ...
                                                        <div class="w-full bg bg-[#e9e9e9] dark:bg-[#3e4852] min-h-10 rounded-b-lg">
                                                            ...
                                                            <form action="{{ route('add-response-admin') }}" method="post" enctype="multipart/form-data" class="response-form">
                                                                ...
                                                                <div class="flex px-4 py-3 justify-around w-full items-start bg-[#e9e9e9] dark:bg-[#3e4852] rounded-b-lg">
                                                                    ...
                                                                    <input type="hidden" name="aduan_id" id="aduan_id" value="{{ $complaint->aduan_id }}">
                                ...
                                <div class="flex items-center h-full gap-4 justify-center">
                                    <form id="delete-aduan-admin-form-{{ $complaint->aduan_id }}" action="{{ route('destroy-aduan-admin', $complaint->aduan_id) }}" method="POST" style="display: none;">
                                        @csrf
                                        @method('DELETE')
                                        <input type="hidden" name="perespon_id" id="perespon_id" value="{{ Auth::user()->penduduk->id_penduduk }}">
                                        <input type="hidden" name="aduan_id" id="aduan_id" value="{{ $complaint->aduan_id }}">
                                    ...
                                    <button type="button" class="flex justify-center items-center gap-2 w-fit text-white bg-[#FF5E5E] rounded-full sm:rounded-lg shadow-xl font-bold h-full px-3 py-3 sm:py-2 hover:bg-[#B34242] hover:scale-105 transition-all" onclick="event.preventDefault(); if(confirm('Apakah Anda yakin ingin menghapus aduan ini?')) document.getElementById('delete-aduan-admin-form-{{ $complaint->aduan_id }}').submit();">
                                        <i class="fa-solid fa-trash-can"></i>
                                        <div class="hidden sm:inline-flex">Hapus</div>
                                    </button>
                                </div>
                                <div class="relative h-fit" x-data="{ 'outsideStatusModal': false }" @keydown.escape="outsideStatusModal = false">

                                    @if (array_key_exists($complaint->status, $stat))
                                    <button @click="outsideStatusModal = true" class="flex justify-center items-center gap-2 w-8 h-8 {{ $stat[$complaint->status]['classContent'] }}" value="{{ $stat[$complaint->status]['value'] }}">
                                        <i class="fa-solid text-lg {{ $stat[$complaint->status]['icon'] }}"></i>
                                    </button>
                                    @endif
                                    <div x-show="outsideStatusModal" tabindex=-1 aria-hidden="true" class="flex overflow-hidden absolute -left-45 lg:-left-40 2xl:-left-35 -bottom-20 z-999 justify-center items-center w-fit h-fit">
                                        <div class="relative z-[1000] p-4 w-fit max-w-3x1 max-h-[700px]" @click.away="outsideStatusModal = false" x-transition:enter="motion-safe:ease-out duration-300" x-transition:enter-start="opacity-0 scale-90" x-transition:enter-end="opacity-100 scale-100">
                                            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                                                <form class="flex" action="{{ route('update-status-outside', $complaint->aduan_id) }}" method="post">
                                                    @csrf
                                                    {{ method_field('PUT') }}
                                                    <input type="hidden" name="page" id="page" value="{{ request()->page ? request()->page : null }}">
                                                    <input type="hidden" name="search" id="search" value="{{ request()->search ? request()->search : null }}">
                                                    ...
                                                    <input type="hidden" name="aduan_id" value="{{ $complaint->aduan_id }}">
                                                    <div class="items-center p-4">
                                                        <button type="submit" name="statusAduan" class="flex justify-center items-center gap-2 w-8 h-8 text-white bg-[#FFDE68] rounded-full shadow-xl font-bold px-3 py-2 hover:bg-[#B39C49] hover:scale-105 transition-all" value="diproses">
                                                            <i class="fa-solid text-lg fa-minus"></i>
                                                        </button>
                                                    </div>
                                                    <div class="items-center p-4">
                                                        <button type="submit" name="statusAduan" class="flex justify-center items-center gap-2 w-8 h-8 text-white bg-[#76D75D] rounded-full shadow-xl font-bold px-3 py-2 hover:bg-[#38682D] hover:scale-105 transition-all" value="selesai">
                                                            <i class="fa-solid text-lg fa-check"></i>
                                                        </button>
                                                    </div>
                                                    <div class="items-center p-4">
                                                        <button type="submit" name="statusAduan" class="flex justify-center items-center gap-2 w-8 h-8 text-white bg-[#FF5E5E] rounded-full shadow-xl font-bold px-3 py-2 hover:bg-[#B34242] hover:scale-105 transition-all" value="ditolak">
                        ...
                        <td>
                            ...
                            <div class="items-center p-4">
                                <div class="flex justify-center items-center gap-2 w-8 h-8 text-white bg-[#FF5E5E] rounded-full shadow-xl font-bold px-3 py-2">
