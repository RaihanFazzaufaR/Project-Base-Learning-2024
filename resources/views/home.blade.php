...
<div class="relative h-[100vh] w-full flex text-[#1C4F0F] dark:text-[#57BA47] px-15 items-center justify-between" >
    ...
    <div class="absolute pb-[12vh] right-7" data-aos="fade-left" data-aos-duration="1000">
...
<div class="w-[80vw] mx-auto mt-[20vh]  flex flex-col gap-14">
    ...
    <div class="grid lg:grid-cols-3 grid-cols-2 gap-10">
        <div class="relative rounded-xl shadow-lg sm:h-[45vh] md:h-[280px] group hover:-translate-y-3 hover:shadow-2xl transition ease-in-out duration-500 overflow-hidden" data-aos="fade-right" data-aos-duration="1000">
            ...
            <div class="absolute bg-[#F9C0E2]/80 h-[45%] w-full rounded-t-[60px] bottom-0 z-10 opacity-100 justify-center items-center flex group-hover:opacity-100 transition ease-in-out duration-500 translate-y-[100%] group-hover:-translate-y-[0%]">
        ...
        <div class="relative rounded-xl shadow-lg sm:h-[45vh] md:h-[280px] group hover:-translate-y-3 hover:shadow-2xl transition ease-in-out duration-500 overflow-hidden" data-aos="fade-right" data-aos-duration="1000">
            ...
            <div class="absolute bg-[#C2D0EC]/80 h-[45%] w-full rounded-t-[60px] bottom-0 z-10 opacity-100 justify-center items-center flex group-hover:opacity-100 transition ease-in-out duration-500 translate-y-[100%] group-hover:-translate-y-[0%]">
        ...
        <div class="relative rounded-xl shadow-lg sm:h-[45vh] md:h-[280px] group hover:-translate-y-3 hover:shadow-2xl transition ease-in-out duration-500 overflow-hidden" data-aos="fade-right" data-aos-duration="1000">
            ...
            <div class="absolute bg-[#D2BDFF]/80 h-[45%] w-full rounded-t-[60px] bottom-0 z-10 opacity-100 justify-center items-center flex group-hover:opacity-100 transition ease-in-out duration-500 translate-y-[100%] group-hover:-translate-y-[0%]">
        ...
        <div class="relative rounded-xl shadow-lg sm:h-[45vh] md:h-[280px] group hover:-translate-y-3 hover:shadow-2xl transition ease-in-out duration-500 overflow-hidden" data-aos="fade-left" data-aos-duration="1000">
            ...
            <div class="absolute bg-[#C3FBB8]/80 h-[45%] w-full rounded-t-[60px] bottom-0 z-10 opacity-100 justify-center items-center flex group-hover:opacity-100 transition ease-in-out duration-500 translate-y-[100%] group-hover:-translate-y-[0%]">
        ...
        <div class="relative rounded-xl shadow-lg sm:h-[45vh] md:h-[280px] group hover:-translate-y-3 hover:shadow-2xl transition ease-in-out duration-500 overflow-hidden" data-aos="fade-left" data-aos-duration="1000">
            ...
            <div class="absolute bg-[#FCDFAD]/80 h-[45%] w-full rounded-t-[60px] bottom-0 z-10 opacity-100 justify-center items-center flex group-hover:opacity-100 transition ease-in-out duration-500 translate-y-[100%] group-hover:-translate-y-[0%]">
        ...
        <div class="relative rounded-xl shadow-lg sm:h-[45vh] md:h-[280px] group hover:-translate-y-3 hover:shadow-2xl transition ease-in-out duration-500 overflow-hidden" data-aos="fade-left" data-aos-duration="1000">
            ...
            <div class="absolute bg-[#F9C9BB]/80 h-[45%] w-full rounded-t-[60px] bottom-0 z-10 opacity-100 justify-center items-center flex group-hover:opacity-100 transition ease-in-out duration-500 translate-y-[100%] group-hover:-translate-y-[0%]">
...
<div class="relative w-[80vw] mx-auto h-[90vh] flex flex-col mt-[13vh] gap-[45px]">
    <div class="font-bold text-[#1C4F0F] text-5xl text-center w-full py-4 uppercase" id="agenda" data-aos="zoom-in" data-aos-duration="1500">Agenda Warga</div>
