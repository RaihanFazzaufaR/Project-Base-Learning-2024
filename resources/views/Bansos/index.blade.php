...
<div class="bg-[#Fff] min-h-[100vh] px-[65px] py-5 w-[100%] mt-10">
    ...
    <form class=" flex items-center gap-5  ">
        <label for="kategori" class="text-base text-[#2d5523] font-semibold dark:text-white w-fit justify-center flex items-center">Kategori</label>
        <select id="kategori" class="h-fit py-3 text-center border-[3px] border-[#2d5523] text-[#2d5523] text-base rounded-lg bg-gray-50 focus:ring-yellow-500 focus:border-yellow-500 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-yellow-500 dark:focus:border-yellow-500 ">
