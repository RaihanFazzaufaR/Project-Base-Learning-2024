...
<div class="w-[100%] relative flex justify-center items-center">
    ...
    <div
        ...
        <p class="text-[#2d5523] dark:text-white font-sans text-[32px] text-center">Salurkan Bantuan Sosial di Lingkungan RW 3</p>
    </div>
</div>
<div class= "min-h-[100vh] mx-auto py-[34px] w-[90%]">
    ...
    <div class=" flex w-full justify-end mb-4">
        ...
        <div class=" hidden md:flex justify-end ">
            <div class="pb-10" x-data="{ 'editModal': false }" @keydown.escape="editModal = false">
                ...
                <div x-show="editModal" x-cloak tabindex="-1" aria-hidden="true"
                    ...
                    <div class="relative z-[1000] p-4 w-fit max-h-[700px]" @click.away="editModal = false"
                        ...
                        <!-- Modal content -->
                        <div
                            class="relative bg-white dark:bg-[#30373F] rounded-lg shadow   ">
                            <!-- Modal header -->
                            <div
                            ...
                            <form class=" w-full flex flex-col  bg-white dark:bg-[#30373F]" method="POST"
                                ...
                                @csrf
                                <div class="px-4 overflow-y-scroll scrollbar-thumb-[#57BA47] scrollbar-track-[#E4F7DF] scrollbar-thin   max-h-100">
