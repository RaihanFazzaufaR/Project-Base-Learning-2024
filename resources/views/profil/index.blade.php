...
<div class="flex w-[75vw] mx-auto justify-between items-center mb-14">
    <div class="relative w-[25%] rounded-l-xl rounded-r-md border bg-white px-5 py-7 shadow-xl group overflow-hidden">
        <div class="absolute z-[2] top-0 h-full w-full bg-[#19A8EF] left-0 transition ease-in-out duration-500 translate-x-[94%] group-hover:translate-x-0"></div>
        <div class="relative flex w-full h-full justify-center items-center gap-10 z-[3] top-0 left-0">
            <div class="flex flex-col justify-center items-center gap-2">
                ...
                <div class="font-semibold text-[18px] text-gray-500 group-hover:text-gray-200">KK</div>
            </div>
    ...
    <div class="relative w-[25%] rounded-l-xl rounded-r-md border bg-white px-5 py-7 shadow-xl group overflow-hidden">
        <div class="absolute z-[2] top-0 h-full w-full bg-[#FEAD34] left-0 transition ease-in-out duration-500 translate-x-[94%] group-hover:translate-x-0"></div>
        <div class="relative flex w-full h-full justify-center items-center gap-10 z-[3] top-0 left-0">
            <div class="flex flex-col justify-center items-center gap-2">
                <div class="font-bold text-5xl group-hover:text-white">1000</div>
                <div class="font-semibold text-[18px] text-gray-500 group-hover:text-gray-200">Penduduk</div>
            </div>
    ...
    <div class="relative w-[25%] rounded-l-xl rounded-r-md border bg-white px-5 py-7 shadow-xl group overflow-hidden">
        <div class="absolute z-[2] top-0 h-full w-full bg-[#9119EF] left-0 transition ease-in-out duration-500 translate-x-[94%] group-hover:translate-x-0"></div>
        <div class="relative flex w-full h-full justify-center items-center gap-10 z-[3] top-0 left-0">
            <div class="flex flex-col justify-center items-center gap-2">
                <div class="font-bold text-5xl group-hover:text-white">43</div>
                <div class="font-semibold text-[18px] text-gray-500 group-hover:text-gray-200">RT</div>
            </div>
