...
class AduanSeeder extends Seeder
{
    ...
    {
        $data = [
            ['pengadu_id'=> 2, 'judul'=>'Pohon tumbang', 'image'=>null,  'prioritas'=>'penting', 'status'=>'diproses', 'konten_aduan'=>'Pohon di depan rumah saya tumbang, tempat saya berada di JL. Cokrokusumo no 13', 'dibuat_tanggal'=>'2024-04-05'],
